...
public class DefaultVersionInfo implements VersionInfo {
    ...
    protected static final int DIGITS_INDEX = 1;

    protected static final int ANNOTATION_SEPARATOR_INDEX = 2;

    protected static final int ANNOTATION_INDEX = 3;

    protected static final int ANNOTATION_REV_SEPARATOR_INDEX = 4;

    protected static final int ANNOTATION_REVISION_INDEX = 5;

    protected static final int BUILD_SEPARATOR_INDEX = 6;

    protected static final int BUILD_SPECIFIER_INDEX = 7;

    protected static final String SNAPSHOT_IDENTIFIER = "SNAPSHOT";
     ...
     * @param version
     */
    public DefaultVersionInfo(String version, String jobName) throws VersionParseException {
